...
* You can load up the various `.bin` page dumps in the [gfx](../gfx) directory into an
  ...
  * [Scrolltext chars](QMGLJm0atm7hAwYsmbRq2buEDBiyZtGrZu4QMGLJm0atm7gisWLFixYsWLECxYsWLFixYsQLFixYsWLFixAsWLFixYsWLDxdB____5XQgQF______ldCBAXQf___) – shadow in different color without the typical 1-char gap
